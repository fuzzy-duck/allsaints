...
<li><a class="selected" href="Building.php">Building History</a></li><li><a href="ChurchHistory.php">Church History</a></li><li><a href="Incumbents.php">Previous Incumbents</a></li>
          </div>
        </div>
        <div class="sidebaritem">
          <div class="sbihead">
