...
<li><a href="ChurchBells.php">Bells</a></li>
      ...
      <div id="column1">
        <div class="sidebaritem">
          <div class="sbihead">
            <h1>Previous Incumbents</h1>
          </div>
          <div class="sbicontent">
			
<li><a href="Building.php">Building History</a></li><li><a href="ChurchHistory.php">Church History</a></li><li><a class="selected" href="Incumbents.php">Previous Incumbents</a></li>
          </div>
        </div>
        <div class="sidebaritem">
          <div class="sbihead">
