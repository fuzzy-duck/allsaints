<?php
	$pagenum="ChristWelcomestheChildren";
...
<li><a class="selected" href="Windows.php">Windows</a></li>
...
<li><a href="ChurchBells.php">Bells</a></li>
      ...
      <div id="column1">
        <div class="sidebaritem">
          <div class="sbihead">
            <h1>Christ Welcomes the Children</h1>
          </div>
          <div class="sbicontent">
			
<li><a class="selected" href="ChristWelcomestheChildren.php">Christ Welcomes the Children</a></li><li><a href="Ascension.php">The Ascension</a></li><li><a href="BellringersWindow.php">Bellringers Window</a></li><li><a href="FourMarys.php">Four Marys</a></li><li><a href="Entombment.php">The Entombment</a></li><li><a href="Passion.php">Passion of Christ</a></li><li><a href="Annunciation.php">The Annunciation</a></li><li><a href="Adoration.php">The Adoration</a></li><li><a href="StLukesWindow.php">St. Lukes Window</a></li><li><a href="ArchangelMichael.php">Archangel Michael</a></li><li><a href="CelticCross.php">Celtic Cross</a></li><li><a href="TheThreeGraces.php">The Three Graces</a></li>
          </div>
        </div>
        <div class="sidebaritem">
          <div class="sbihead">
